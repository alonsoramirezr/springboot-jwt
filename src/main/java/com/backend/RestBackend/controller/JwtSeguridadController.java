...
import com.backend.RestBackend.seguridad.configuracion.JwtTokenUtil;
import com.backend.RestBackend.seguridad.mensaje.request.LoginForm;
import com.backend.RestBackend.seguridad.mensaje.request.SignUpForm;
import com.backend.RestBackend.seguridad.mensaje.response.JwtResponse;
import com.backend.RestBackend.seguridad.mensaje.response.ResponseMessage;
...
import com.backend.RestBackend.seguridad.repositorio.RoleRepository;
...
public class JwtSeguridadController {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignUpForm signUpRequest) {
        ...
        else if(strRoles.equalsIgnoreCase("pm")){
